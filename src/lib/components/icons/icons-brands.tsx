...
export function BuyMeACoffee(props: React.ComponentProps<'svg'>) {
  return (
    <svg
      role="img"
...
export function GithubIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" {...props}>
      <title>Github</title>
...
export function XTwitterIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg
      role="img"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <path d="M606.773 37.236h117.721L466.02 331.538l301.979 399.227H531.022L345.484 488.158 133.075 730.765H15.354L289.183 415.99 0 37.237h242.863l167.624 221.622zm-41.202 624.432h65.258L208.57 103.774h-70.12z" />
    </svg>
  )
}
...
export function MastodonIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg role="img" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" {...props}>
...
export function PatreonIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg
      role="img"
      xmlns="http://www.w3.org/2000/svg"
...
export function TwitchIcon(props: React.ComponentProps<'svg'>) {
  return (
    ...
    >
      <title>Twitch</title>
      <path d="M11.57 4.71h1.72v5.15h-1.72zm4.72 0H18v5.15h-1.71zM6 0 1.71 4.29V19.7h5.15V24l4.28-4.29h3.43L22.3 12V0zm14.57 11.14-3.43 3.43h-3.43l-3 3v-3H6.86V1.71h13.71Z" />
    </svg>
  )
}
...
export function DeviantArtIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
